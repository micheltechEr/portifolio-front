...
export const ImageRenderCurriculum = ({ isEnglish }) => {
    if (isEnglish === 'en') {
        return <img src={curriculumEngl} className="curriculum-image" alt="Curriculum Image" />
    }
    return <img src={curriculumImage} className="curriculum-image" alt="Imagem do Curriculo" />
}
